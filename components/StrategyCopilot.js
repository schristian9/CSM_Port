        ...
        <div className="lg:col-span-4 flex flex-col justify-between zine-card bg-[#F5F1E8] p-8">
          <div>
            ...
            <div className="space-y-3">
              <span className="font-mono text-xs text-[#BFA175] font-bold block uppercase tracking-wide">
                Quick Prompts
              </span>
          ...
          <div ref={chatContainerRef} className="flex-1 overflow-y-auto p-6 space-y-6 bg-[#F5F1E8] grid-bg bg-opacity-20">
            ...
            {loading && (
              <div className="flex justify-start">
                <div className="bg-[#FFFDF9] p-4 zine-border shadow-[2px_2px_0px_0px_rgba(27,28,30,1)] min-w-[120px] flex items-center justify-center py-6">
