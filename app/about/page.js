...
export default function About() {
  ...
  return (
    <div className="min-h-screen flex flex-col selection:bg-[#95B1EE] selection:text-white relative">
      ...
      <main className="flex-1 w-full bg-[#FFFDF5] py-16 px-4 md:px-8">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12">
          
          {/* Left Column: Personal Card & Details */}
          <div className="lg:col-span-4 lg:sticky lg:top-36 space-y-6 self-start">
            <div className="zine-card bg-[#E7F1A8] p-8 relative overflow-hidden">
              <div className="absolute top-0 right-0 w-24 h-24 grid-bg opacity-15"></div>
              
              <div className="border-b border-[#364C84] pb-6 mb-6">
                <div className="zine-badge mb-3">PERSONAL DOSSIER</div>
                <h2 className="text-3xl font-display font-black text-[#364C84] uppercase leading-tight">
                  Sarlinson Christian
                </h2>
                <p className="text-sm font-mono text-[#95B1EE] uppercase font-bold mt-1.5">
                  Technical CS & Onboarding Leader
                </p>
              </div>

              {/* Contact Information */}
              <div className="space-y-4 font-mono text-xs text-[#364C84]">
                <div className="flex justify-between py-2 border-b border-[#364C84]/10">
                  <span className="text-gray-500">LOCATION</span>
                  <span className="font-bold">LONDON, UK</span>
                </div>
                <div className="flex justify-between py-2 border-b border-[#364C84]/10">
                  <span className="text-gray-500">EMAIL</span>
                  <a href="mailto:sarlinson92@yahoo.com" className="font-bold hover:text-[#95B1EE] underline">
                ...
                <div className="flex justify-between py-2 border-b border-[#364C84]/10">
                  ...
                  <a href="https://linkedin.com/in/sarlinson" target="_blank" rel="noopener noreferrer" className="font-bold hover:text-[#95B1EE] underline">
            ...
            <div className="zine-card bg-[#E7F1A8] p-8">
              <h4 className="font-display font-black text-xl text-[#364C84] uppercase border-b border-[#364C84] pb-3 mb-4">
                Education
              </h4>
              <div className="space-y-4">
                <div>
                  <h5 className="text-lg font-bold text-[#364C84] leading-snug">
                    Bachelor of Business Administration (2026)
                  </h5>
                  <p className="text-sm text-gray-600 font-mono mt-1">DY Patil University</p>
                </div>
                <div className="border-t border-[#364C84]/10 pt-4">
                  <h5 className="text-lg font-bold text-[#364C84] leading-snug">
            ...
            <div className="zine-card bg-[#364C84] text-[#FFFDF5] p-8 relative overflow-hidden shadow-[3px_3px_0px_0px_rgba(191,161,117,1)] border border-[#95B1EE]">
              <div className="absolute top-0 right-0 w-20 h-20 grid-bg opacity-10"></div>
              <span className="font-mono text-[10px] text-[#95B1EE] uppercase tracking-widest block mb-4">PERSISTENCE AUDIT</span>
              <p className="text-xl font-display font-semibold italic text-[#FFFDF5] leading-relaxed">
          ...
          <div className="lg:col-span-8 space-y-12">
            ...
            <div className="zine-card bg-[#E7F1A8] p-8 md:p-10">
              <div className="border-b border-[#364C84] pb-6 mb-8">
                <div className="zine-badge mb-3">VISUAL TRAJECTORY</div>
                <h3 className="text-2xl md:text-4xl font-display font-black text-[#364C84] uppercase">
                  Clinical-to-Technical Growth
                </h3>
                <p className="text-sm font-mono text-[#95B1EE] mt-1.5 uppercase font-semibold">
                  How nursing principles fuel onboarding velocity & AI adoption in healthcare SaaS.
                </p>
                <div className="border-l-4 border-[#364C84] pl-4 mt-6">
                  <p className="text-lg font-display font-semibold italic text-[#95B1EE] leading-relaxed">
              ...
              <div className="relative">
                <div className="absolute left-6 top-2 bottom-2 w-0.5 bg-[#364C84] border-dashed border-r"></div>

                <div className="space-y-10">
                  {trajectory.map((step, idx) => (
                    <div key={idx} className="flex gap-6 items-start relative z-10">
                      <div className="w-12 h-12 rounded-full border-2 border-[#364C84] bg-[#E7F1A8] flex flex-col items-center justify-center font-display font-black text-[10px] shrink-0 shadow-[2px_2px_0px_0px_rgba(27,28,30,1)]">
                        {step.year.split(" - ").pop()}
                      </div>
                      
                      <div className="flex-1 bg-[#FFFDF5] border border-[#364C84] p-6 shadow-[3px_3px_0px_0px_rgba(27,28,30,1)]">
                        <div className="flex flex-wrap justify-between items-baseline gap-2 mb-2">
                          <h4 className="font-display font-black text-lg md:text-xl text-[#364C84] uppercase leading-none">
                            {step.role}
                          </h4>
                          <span className="font-mono text-xs text-[#95B1EE] font-bold">@ {step.company}</span>
                        </div>
                        <p className="text-xs font-mono uppercase text-gray-500 font-bold mb-4">{step.highlight}</p>
                        
                        <ul className="space-y-2 text-base text-[#364C84] leading-relaxed">
                          {step.achievements.map((ach, i) => (
                            <li key={i} className="flex gap-3 items-start">
                              <span className="inline-block mt-2 w-1.5 h-1.5 bg-[#95B1EE] shrink-0"></span>
            ...
            <div className="zine-card bg-[#E7F1A8] p-8 md:p-10">
              <div className="border-b border-[#364C84] pb-6 mb-8">
                ...
                <h3 className="text-2xl md:text-3xl font-display font-black text-[#364C84] uppercase">
                  Healthcare AI Platform Implementation
                </h3>
              </div>
              
              <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-stretch">
                <div className="md:col-span-7 bg-[#FFFDF5] border border-[#364C84] p-6 shadow-[3px_3px_0px_0px_rgba(27,28,30,1)] flex flex-col justify-between">
                  <div>
                    <div className="flex justify-between items-baseline mb-3">
                      <h4 className="font-display font-black text-lg text-[#364C84] uppercase">
                        AI-Driven Health Platform — DecodeDx
                      </h4>
                      <span className="zine-badge bg-[#95B1EE] text-white">-25% User Drop-Off</span>
                    </div>
                    <p className="text-base text-[#364C84] leading-relaxed">
                ...
                <div className="md:col-span-5 relative border border-[#364C84] shadow-[3px_3px_0px_0px_rgba(27,28,30,1)] overflow-hidden min-h-[200px]">
                  <Image
            ...
            <div className="zine-card bg-[#E7F1A8] p-8 md:p-10">
              ...
              <div className="space-y-6">
                <div>
                  <h4 className="font-mono text-xs font-bold text-[#95B1EE] uppercase tracking-wider mb-3">
                    Customer Success & Adoption
                  </h4>
                  <div className="flex flex-wrap gap-2">
                    {skills.csAdoption.map((s, i) => (
                      <span key={i} className="px-3 py-1.5 border border-[#364C84] bg-[#FFFDF5] font-mono text-xs text-[#364C84] shadow-[1px_1px_0px_0px_rgba(27,28,30,1)]">
                        {s}
                      </span>
                    ))}
                  </div>
                ...
                <div className="border-t border-[#364C84]/10 pt-6">
                  <h4 className="font-mono text-xs font-bold text-[#95B1EE] uppercase tracking-wider mb-3">
